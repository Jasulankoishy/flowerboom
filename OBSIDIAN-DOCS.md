...
- ✅ **Email + Пароль авторизация** (новое!)
- ✅ **Google OAuth 2.0** (новое!)
- ✅ **Тёмная/светлая тема** с переключателем (новое!)
- ✅ JWT авторизация (access + refresh токены, 7 дней)
- ✅ Админ-панель для управления товарами
- ✅ **Base64 хранение фото** в SQLite (новое!)
